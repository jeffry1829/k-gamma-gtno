...
def main():
    ...
    # praw=[0,-0.9,0,-0.9,0,-0.9,0,0,0,0,0,0,0,  0, 5.3280 ,2.3564, 4.0969 , -0.7854] # AFM kitaev no LG
    praw=[0,-0.9,0,-0.9,0,-0.9,0,0,0,0,0,0,0, 5.3280 ,2.3564, 4.0969 , -0.7854] # AFM kitaev no LG no LG parameter
    # praw = []
    # for i in range(num_params):
    #     praw.append(random.random())
