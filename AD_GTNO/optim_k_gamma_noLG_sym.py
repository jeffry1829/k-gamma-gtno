...
# -------- filenames --------
Efn = f"datas/kg_sym_E1.txt"
magfn = f"datas/kg_sym_mag1.txt"
csfn = f"datas/kg_sym_cs1.txt"
# -------- filenames --------
...
##            params[i]+= noise * rand_t[0]
        ...
        # praw = [0.3298, -0.7930, -0.0833, 0.3409, 0.0113, -0.1157, -0.0110, -0.0180-0.0805j, -0.0246+0.0409j, -0.5349+0.8605j, 0.7144-0.1709j, -0.3380+0.4929j, -1.0177+0.1390j, -0.2417+0.7808j, -0.9978+0.5322j]
    ...
    phis = np.pi*np.linspace(0.0, 0.5, 50)
