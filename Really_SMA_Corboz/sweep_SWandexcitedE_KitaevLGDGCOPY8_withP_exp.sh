...
bond_dim=4
_size=3
statefile="KitaevLGDG.json"
_step=1
_device="cuda:2"
_dtype="complex128"
datadir="data/KitaevLGDG_withP_Jx${Jx}Jy${Jy}Jz${Jz}h${h}chi${chi}size${_size}bonddim${bond_dim}dtype${_dtype}/"
reuseCTMRGenv="True"
...
StoredMatMethod="SMA_stored_mat_Kitaev_exp.py"
SMAMethod="SMA_Kitaev_withP_exp.py"
runSMA="True"
runStoredMat="True"
runDraw="True"
onlyOnePoint="True"
