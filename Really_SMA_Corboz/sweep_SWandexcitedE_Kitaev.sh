...
extra_flags="--CTMARGS_ctm_force_dl True --MultiGPU False --CTMARGS_projector_eps_multiplet 1e-4 --CTMARGS_ctm_conv_tol 2e-6"
# --CTMARGS_fpcm_freq 3 --CTMARGS_fpcm_fpt_tol 2e-6 --CTMARGS_fpcm_isogauge_tol 2e-6"
StoredMatMethod="SMA_stored_mat_Kitaev_truncate.py"
