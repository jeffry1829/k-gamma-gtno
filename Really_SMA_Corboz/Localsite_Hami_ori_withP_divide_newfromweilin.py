...
def Create_Hami_Env(state, stateDL, B_grad, env, P, Pt, lam, Hx, Hy, kx, ky, args):
                ...
                for i in range(args.size+1):
                    ...
                    for j in range(2*args.size+2):
                        ...
                        if i == args.size and j == args.size:
                            ...
                            # if i % 2 == 1:
                            nT = contract(nT, Hy, ([2, 3, 5], [0, 2, 1]))
                            tempT = contiguous(
                                permute(nT, (1, 6, 2, 0, 3, 4, 5)))
                            # else:
                            #     nT = contract(nT, Hy, ([2, 3], [0, 2]))
                            #     tempT = contiguous(
                ...
                for i in range(args.size+1):
                    ...
                    for j in range(2*args.size+2):
                        ...
                        if i == 0:
                            ...
                            # if i % 2 == 1:
                            nT = contract(nT, Hy, ([1, 2, 3], [0, 2, 1]))
                            tempT = contiguous(
                                permute(nT, (0, 4, 1, 2, 3)))
                            # else:
                            #     nT = contract(nT, Hy, ([1, 2, 4], [0, 2, 3]))
                            #     tempT = contiguous(
                            #         permute(nT, (0, 1, 4, 2, 3)))
...
def Create_Hami(state, env, C_up, T_up, C_left, T_left, C_down, T_down, C_right, T_right, Hx, Hy, args):
    phys_dim = state.site((0, 0)).size()[0]
    Hami = dict()
    Hami2 = dict()
    for coord in state.sites.keys():
        ...
        #     H1 = contract(H1, Hy, ([0, 1, 7, 8], [0, 2, 1, 3]))
        #     H1 = contiguous(
