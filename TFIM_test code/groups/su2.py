...
class SU2():
    ...
    def SZ(self):
        ...
        :rtype: torch.tensor
        """
        print('Sz:', get_op("sz",self.J,dtype=self.dtype,device=self.device))
    ...
    def SX(self):
        r"""
        :return: :math:`S^x` operator of irrep.
        :rtype: torch.tensor
        """
        print('SX:', 0.5*(self.SP()+self.SM()))
        return 0.5*(self.SP()+self.SM())
