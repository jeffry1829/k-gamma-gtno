...
def optimize_state(state, ctm_env_init, loss_fn, params, obs_fn=None, post_proc=None,
    ...
    optimizer = lbfgs_modified.LBFGS_MOD(params2, max_iter=opt_args.max_iter_per_epoch, lr=opt_args.lr, \
    ...
    def closure(linesearching=False):
        ...
        if obs_fn is not None:
            obs_fn(state, current_env[0], params, context)
