...
if len(state.sites) == 1:
    ...
    if (args.NormMat == True):
        ...
        # # ADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
        # Norm[(0, 0)] = Norm[(0, 0)] - Norm[(0, 0)].detach()
        # ##########################################################################################################################################
        ...
        with torch.autograd.graph.save_on_cpu(True):
            ...
            for ii in range(elemsize):
                ...
                with torch.cuda.stream(streams[ii]):
                    ...
                    # # ADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
                    # HamiMat0[tuple(loc)] = HamiMat0[tuple(loc)] - \
                    #     HamiMat0[tuple(loc)].detach()
                    # ########################################################################################################################################################
