...
for i in {0..25}
do
  python ../../optim_kitaev3.py --bond_dim 2 --chi 9 --instate_noise 0.001 --seed 123 --kx 0.0 --ky 0.0 --kz 1.0 --h ${a[i+1]} --instate ${a[i]}_state.json --out_prefix ${a[i+1]} --GLOBALARGS_dtype complex128 --GLOBALARGS_device cuda:1
done