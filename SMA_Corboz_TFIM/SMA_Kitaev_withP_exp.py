...
if len(state.sites) == 1:
    ...
    if (args.NormMat == True):
        ...
        NormMat = view(NormMat, (1024, 1024))
        temp = contract(NormMat, conj(
    ...
    if (args.HamiMat == True):
        ...
        C_up, T_up, C_left, T_left, C_down, T_down, C_right, T_right = Create_Localsite_Hami_Env(state, stateDL, B_grad, env, lam,
                                                                                                 Hy, Hz, Hx, II, kx, ky, C_up, T_up, C_left, T_left, C_down, T_down, C_right, T_right, args, True, True, P, Pt, isOnsiteWorking=isOnsiteWorking)
        ...
        HamiMat = view(HamiMat, (1024, 1024))
        temp = contract(HamiMat, conj(
            view(state.site((0, 0)), (1024))), ([1], [0]))
