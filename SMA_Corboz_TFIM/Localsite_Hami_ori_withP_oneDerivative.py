...
def Create_Localsite_Hami_Env(state, stateDL, B_grad, env, lam, Hx, Hy, Honsite, Id, kx, ky,
    ...
    for vac_x in range(args.size*2+2):
        for vac_y in range(args.size*2+2):
            vac_pos = (vac_x, vac_y)
                    ...
                    if direction == (0, -1):
                            ...
                            for j in range(2*args.size+2):
                                ...
                                if j % 2 == 0:
                                    if i == args.size and j == args.size and lasttime:
                                        if vac_pos[0] == j and vac_pos[1] == i:
                                            nT = contract(
                                                Pt2, T_up[(j)], ([0], [0]))
                                            dimsA = state.site(
                                                new_coord).size()
                                            ...
                                            # now nT=
                                            #        |------T-----7 chi   phy_in_T 3,4
                                            # chi 2-Pt2    5,6
                                            #        |---0,1
                                            nT = contract(
                                                nT, view(P1, (env.chi, dimsA[4], dimsA[4], env.chi)), ([7], [0]))
                                            # now nT=
                                            #        |------T-----|   phy_in_T 3,4
                                            # chi 2-Pt2    5,6    |
                                            #        |---0,1     7,8-----9
                                            if i % 2 == 1:
                                                nT = contract(nT, permute(
                                                    HyAndOnsiteLst, (1, 0, 3, 2)), ([3, 4], [0, 2]))
                                                # now nT=
                                                #        |------T-----|   phy_in_hollow 8,9
                                                # chi 2-Pt2    3,4    |
                                                #        |---0,1     5,6-----7
                                                tempT = contiguous(
                                                    permute(nT, (2, 8, 9, 3, 4, 0, 1, 5, 6, 7)))
                                                # now nT=
                                                #        |------T-----|   phy_in_hollow 1,2
                                                # chi 0-Pt2    3,4    |
                                                #        |---5,6     7,8-----9
                                                ...
                                                nT = contract(
                                                    nT, HyAndOnsiteFst, ([3, 4], [0, 2]))
                                                tempT = contiguous(
                                                    permute(nT, (2, 8, 9, 3, 4, 0, 1, 5, 6, 7)))
                                                # now nT=
                                                #        |------T-----|   phy_in_hollow 1,2
                                                # chi 0-Pt2    3,4    |
                                                #        |---5,6     7,8-----9  O(D^6 d^2 chi^2)
                                            norm = tempT.detach()
                                            T_up[(j)] = tempT/norm.abs().max()
                                        elif vac_pos[1] > i or vac_pos[0] != j:
                                            nT = contract(
                                                Pt2, T_up[(j)], ([0], [0]))
                                            dimsA = state.site(
                                                new_coord).size()
                                            ...
                                            #    7-Pt2---6
                                            nT = view(
                                                nT, (dimsA[2], dimsA[1], phys_dim, dimsA[3], dimsA[4], env.chi, dimsA[2], dimsA[2], env.chi))
                                            # now nT=
                                            #           |-----T----|
                                            #       |-- |     1    |--5       phy_in_cA 2
                                            #       |   |---0 cA 4-|
                                            ...
                                            #                  10
                                            nT = contract(
                                                nT, view(P1, (env.chi, dimsA[4], dimsA[4], env.chi)), ([5, 11], [0, 1]))
                                            # now nT=
                                            #           |-----T----|
                                            #       |-- |     1    |--|       phy_in_cA 2
                                            #       |   |---0 cA 4-|  |       phy_in_A  7
                                            ...
                                            if i % 2 == 1:
                                                nT = contract(nT, permute(
                                                    HyAndOnsiteLst, (1, 0, 3, 2)), ([2, 7], [2, 1]))
                                                # now nT=
                                                #           |-----T----|
                                                #       |-- |     1    |--|       phy_in_cA 10
                                                #       |   |---0 cA 3-|  |       phy_in_A 11
                                        ...
                                        if i == 0 and firsttime:
                                            if vac_pos[0] == j and vac_pos[1] == i:
                                                ...
                                                #           |---0,1
                                                nT = contract(
                                                    nT, conj(state.site(new_coord)), ([1, 4], [2, 1]))
                                                # now nT=
                                                #           |------T---3
                                                #  1 chi---Pt2     2          phy_in_cA 4
                                                #           |---0 cA 6
                                                #                  5
                                                nT = contract(
                                                    nT, view(P1, (env.chi, dimsA[4], dimsA[4], env.chi)), ([3, 6], [0, 2]))
                                                # now nT=
                                                #           |------T---|
                                                #   1 chi--Pt2     2   P--6       phy_in_cA 3
                                                #           |---0 cA 5-|
                                                #                  4
                                                nT = contiguous(
                                            ...
                                            if vac_pos[0] == j and vac_pos[1] == i:
                                                ...
                                                #                    7
                                                nT = contract(
                                                    nT, view(P1, (env.chi, dimsA[4], dimsA[4], env.chi)), ([5, 8], [0, 2]))
                                                # now nT=
                                                #           |--------T------|
                                                #  1 chi---Pt2       4      |       phy_in_T 2,3
                                                #           |---0   cA   7--|--8    phy_in_cA 5
                                                #                    6
                                                if i % 2 == 1:
                                                    nT = contract(nT, permute(
                                                        HyAndOnsiteLst, (1, 0, 3, 2)), ([2, 3, 5], [0, 2, 3]))
                                                    # now nT=
                                                    #           |--------T------|
                                                    #  1 chi---Pt2       2      |       phy_in_T
                                                    #           |---0   cA   4--|--5    phy_in_cA 6
                                                    #                    3
                                                    tempT = contiguous(
                                                        permute(nT, (1, 6, 2, 0, 3, 4, 5)))
                                                    # now nT=
                                                    #           |--------T------|
                                                    #  0 chi---Pt2       2      |
                                                    #           |---3   cA   5--|--6    phy_in_cA 1
                                                    #                    4
                                                else:
                                                    nT = contract(
                                                        nT, HyAndOnsiteFst, ([2, 3, 5], [0, 2, 3]))
                                                    # now nT=
                                                    #           |--------T------|
                                                    #  1 chi---Pt2       2      |       phy_in_T
                                                    #           |---0   cA   4--|--5    phy_in_cA 6
                                                ...
                                                T_up[(j)] = tempT / \
                                                    norm.abs().max()
                                            elif vac_pos[1] == i-1 and vac_pos[0] == j:
                                                # now Tup=
                                                #           |--------T------|
                                                #   0 chi---|        2      |
                                                #           |---3   cA   5--|--6    phy_in_cA 1
                                                ...
                                                #       |            5          |
                                                #       |                       |
                                                #   1---|---0               7---|---8     O(D^6 d^1 chi^2)

                                                Aket = state.site(new_coord)
                                                DL = view(contiguous(einsum('mefgh,nabcd->mneafbgchd', Aket, conj(state.site(new_coord)))),
                                                          (phys_dim, phys_dim, dimsA[1], dimsA[1], dimsA[2]**2, dimsA[3]**2, dimsA[4]**2))
                                                # now DL=
                                                #           2,3
                                                #   4   A conj(A)  6         phy 0,1
                                                #           5
                                                ...
                                                #       |                       |    phy_in_DL 6,7
                                                #       |            8          |
                                                #   0---|---        DL       ---|---5     O(D^6 d^3 chi^2)
                                                #                    9
                                                if i % 2 == 1:
                                                    nT = contract(nT, permute(
                                                        HyAndOnsiteLst, (1, 0, 3, 2)), ([1, 7], [2, 3]))
                                                    # now nT=
                                                    #           |--------T------|
                                                    #       |---|        1      |
                                                    #       |   |---2   cA   3--|---|    phy_in_cA 8
                                                ...
                                                if i % 2 == 1:
                                                    nT = contract(
                                                        nT, permute(
                                                            HyAndOnsiteLst, (1, 0, 3, 2)), ([5, 9], [0, 2]))
                                                else:
                                                    nT = contract(
                                                        nT, HyAndOnsiteFst, ([5, 9], [0, 2]))
                                                # now nT=
                                                #           |--------T------|
                                                #       |---|        1      |
                                                #       |   |---2   cA   3--|---|         phy_in_cA 7
                                                ...
                                                #     |           |
                                                #     |     2     |
                                                #   5-|---Lower---|-7      phy_in_Lower 0,1
                                                #           3
                                                nT = contract(
                                                    nT, Lower, ([0, 4, 6, 9], [4, 6, 2, 1]))
                                                # now nT=
                                                #             |--------T------|
                                                #         |---|        0      |
                                                #         |   |---1   cA   2--|---|         phy_in_cA 4
                                                ...
                                                #                      7
                                                nT = contiguous(
                                                    permute(nT, (8, 0, 1, 2, 9, 6, 3, 7, 4, 5)))
                                                # now nT=
                                                #           |--------T------|
                                                #       |---|        1      |
                                                #       |   |---2   cA   3--|---|         phy_in_cA 8
                        ...
                        for i in range(args.size+1):
                            ...
                            for j in range(2*args.size+2):
                                ...
                                if j % 2 == 0:
                                    if i == 0 and firsttime:
                                        if vac_pos[0] == j and 2*args.size+2-1-vac_pos[1] == i:
                                            nT = contract(
                                                P1, T_down[(j)], ([0], [1]))
                                            dimsA = state.site(
                                                new_coord).size()
                                            ...
                                            #     3--|------T1
                                            nT = view(
                                                nT, (dimsA[3], dimsA[3], env.chi, dimsA[2], dimsA[2], env.chi))
                                            # now nT=
                                            #        |--3,4
                                            #        |     0,1
                                            #     5--|------T-----2
                                            nT = contract(nT, conj(
                                                state.site(new_coord)), ([4, 1], [2, 3]))
                                            # now nT=
                                            #                     5
                                            #        |--2        cA--6              phy_in_cA 4
                                            #        |
                                            ...
                                            #     3--|------------T-----------1
                                            nT = contract(
                                                nT, view(Pt2, (env.chi, dimsA[4], dimsA[4], env.chi)), ([1, 6], [0, 2]))
                                            # now nT=
                                            #                     4
                                            #        |--1        cA         5--|     phy_in_cA 3
                                            #        |                         |
                                        ...
                                        elif 2*args.size+2-1-vac_pos[1] > i or vac_pos[0] != j:
                                            nT = contract(
                                                P1, T_down[(j)], ([0], [1]))
                                            # now nT=
                                            #        |--0
                                        ...
                                        if vac_pos[0] == j and 2*args.size+2-1-vac_pos[1] == i:
                                            ...
                                            #       2--|--|----------T---------|--7
                                            nT = contract(
                                                nT, conj(state.site(new_coord)), ([1, 6], [2, 3]))
                                            # now nT=
                                            #                        7
                                            #          |--0         cA--8
                                            #          |             4                 phy_in_DL 2,3
                                            ...
                                            #       1--|--|----------T---------|--5
                                            nT = contract(
                                                nT, view(Pt2, (env.chi, dimsA[4], dimsA[4], env.chi)), ([5, 8], [0, 2]))
                                            # now nT=
                                            #                        6
                                            #          |--0         cA         7--|
                                            #          |             4            |     phy_in_DL 2,3
                                            ...
                                            T_down[(j)] = tempT / \
                                                norm.abs().max()
                                        elif 2*args.size+2-1-vac_pos[1] == i-1 and vac_pos[0] == j:
                                            nT = T_down[(j)]
                                            # now nT=
                                            #                      2
                                            #          |--3       cA       5--|
                                            ...
                                            if i % 2 == 1:
                                                nT = contract(
                                                    nT, HyAndOnsiteFst, ([1], [2]))
                                                # now nT=
                                                #                      1
                                                #          |--2       cA       4--|
                                                #          |           3          |     phy_in_cA 6
                                                #       0--|-----------T----------|--5  phy_out_cA 7,8

                                                # tempT = contiguous(
                                                #     permute(nT, (0, 4, 1, 2, 3)))
                                            else:
                                                nT = contract(nT, permute(
                                                    HyAndOnsiteLst, (1, 0, 3, 2)), ([1], [2]))
                                                # now nT=
                                                #                      1
                                                #          |--2       cA       4--|
                                                #          |           3          |     phy_in_cA 6
                                            ...
                                            Aket = state.site(new_coord)
                                            DL = view(contiguous(einsum('mefgh,nabcd->mneafbgchd', Aket, conj(state.site(new_coord)))),
                                                      (phys_dim, phys_dim, dimsA[1]**2, dimsA[2]**2, dimsA[3], dimsA[3], dimsA[4]**2))
                                            # now DL=
                                            #       2
                                            #   3  AcA  6      phy 0,1
                                            #      4,5
                                            ...
                                            #       |  |--0       cA       2--|  |
                                            #       |  |           1          |  |  phy_in_cA 3
                                            #       |--|-----------T----------|--|  phy_in_DL 4,5 O(D^6 d^3 chi^2)
                                            tempT = contiguous(nT)
                                            ...
                                            if i % 2 == 1:
                                                ...
                                                #       |  |--0       cA       2--|  |
                                                #       |  |           1          |  |  phy_in_cA 3
                                                #       |--|-----------T----------|--|  phy_out_DL 8,9 O(D^6 d^3 chi^2)

                                                # tempT = contiguous(
                                                #     permute(nT, (0, 4, 1, 2, 3)))
                                            else:
                                                nT = contract(nT, permute(
                                                    HyAndOnsiteLst, (1, 0, 3, 2)), ([4, 5], [0, 2]))
                                                # now nT=
                                                #                      4
                                                #    6--|-------------DL-------------|--7
                                                #       |              5             |
                                            ...
                                            #          |--5       7--|
                                            Upper = view(
                                                Upper, (phys_dim, phys_dim, dimsA[1]**2, dimsA[3]**2, dimsA[2], env.chi, dimsA[4], env.chi))
                                            # now Upper=
                                            #                 2
                                            #       5--|-----AcA-----|--7      phy 0,1
                                            #          |      3      |
                                            ...
                                            #            |  |--0       cA       2--|  |
                                            #            |  |           1          |  |  phy_in_cA 3
                                            #            |--|-----------T----------|--|  phy_in_DL2 5,6 O(D^6 d^3 chi^2)
                                            nT = contiguous(
                                                permute(nT, (0, 1, 2, 3, 5, 6, 7, 4, 8, 9)))
                                            # now nT=
                                            #                      6
                                            #    8--|-------------DL-------------|--9
                                            #       |              7             |
...
def Create_Localsite_Hami(state, env, C_up, T_up, C_left, T_left, C_down, T_down, C_right, T_right, Hx, Hy, Honsite, Id, args, isOnsiteWorking, vac_pos):
    phys_dim = state.site((0, 0)).size()[0]
    Hami = dict()
    OI = torch.einsum('ij,ab->iajb', Honsite, Id)
    IO = torch.einsum('ij,ab->iajb', Id, Honsite)
            ...
            if i % 2 == 0:
                if vac_pos[1] == i:
                    ...
                    if vac_pos[0] == args.size-1:
                        ...
                        temp = contract(T_up[(i)], FL, ([0], [0]))
                        # now temp=
                        #           |--------T------|
                        #      |---Pt2       1      |
                        #      |    |---2   cA   4--|--5    phy_in_cA 0
                        #      |             3
                        #      |--6
                        temp = contract(temp, HyAndOnsiteBoth,
                                        ([0], [2]))
                        # now temp=
                        #           |--------T------|
                        #      |---Pt2       0      |
                        #      |    |---1   cA   3--|--4    phy_in_cA 6
                        #      |             2              phy_out_cA 7,8
                        #      |--5
                        tmpTdown = view(
                            T_down[(i)], (env.chi, phys_dim, phys_dim, dimsA[1], dimsA[1], env.chi))
                        # now tmpTdown=
                        #                 3,4
                        #           |-----DL-----|
                        #  0 chi---Pt2    |     P1---chi 5
                        #           |-----T------|             phy_in_DL 1,2
                        temp = contract(
                            temp, tmpTdown, ([5, 2, 7, 8], [0, 4, 1, 2]))
                        # now temp=
                        #           |--------T------|
                        #      |---Pt2       0      |
                        #      |    |---1   cA   2--|--3    phy_in_cA 4
                        #      |           5
                        #      |    |-----DL-----|
                        #      |----|            |-----6
                        #           |-----T------|
                        ...
                        #      |-2        0
                        temp = view(
                            temp, (dimsA[3], dimsA[3], env.chi, dimsA[2], phys_dim, phys_dim))
                        # now temp=
                        #           |-----T-----|
                        #      |---Pt2    |     P1---chi 2
                        #      |    |-----DL----|             phy_out_DL 4,5
                        ...
                        # now temp=
                        #           |-----T-----|
                        #      |---Pt2    |     P1---chi 1          phy_out_DL 3,4
                        #      |    |-----DL----|
                        #      |          0
                        #      |
                        #      |--2
                        temp = contract(
                            temp, T_down[(i)], ([2, 0, 3, 4], [8, 6, 4, 5]))
                        # now temp=
                        #           |-----T-----|
                        #      |---Pt2    |     P1---chi 0
                        #      |    |-----DL----|
                    ...
                    if vac_pos[0] == args.size-1:
                        ...
                        #  0 chi---Pt2    |     P1---chi 4
                        #           |-----T------|             phy_in_DL 1,2
                        temp = contract(T_up[(i)], FL, ([0], [3]))
                        # now temp=
                        #           |--------T------|
                        #      |---Pt2       0      |
                        #      |    |---1   cA   2--|--------T_up------9   phy_in_cA 3
                        #      |           4                  8           phy_in_T_up 6,7
                        #      |    |-----DL-----|
                        #      |----|            |-----5
                        #           |-----T------|
