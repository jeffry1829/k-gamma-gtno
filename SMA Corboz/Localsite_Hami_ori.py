...
def Create_Localsite_Hami_Env(state, stateDL, B_grad, env, lam, Hx, Hy, Honsite, Id, kx, ky,\
    C_up, T_up, C_left, T_left, C_down, T_down, C_right, T_right, args, firsttime, lasttime):
                    ...
                    for j in range(2*args.size+2):
                        ...
                        if j%2 == 0:
                            if i == args.size and j == args.size and lasttime:
                                ...
                                #               6
                                if i%2==1:  
                                    nT = contract(nT, permute(HyAndOnsiteLst, (1,0,3,2)),([2,3,5],[0,2,1]))
                                    tempT = contiguous(permute(nT, (1,6,2,0,3,4,5)))
                                else:
                                    nT = contract(nT, HyAndOnsiteFst,([2,3],[0,2]))
                                ...
                                if i == 0 and firsttime:
                                    ...
                                    #         2  3
                                    if i%2==1:
                                        nT = contract(nT, permute(HyAndOnsiteLst, (1,0,3,2)),([1,2,3],[0,2,1]))
                                        # Guess now
                                        #           |-----T-----|
                                        #  0 chi---Pt2    |     P1---chi 3
                                        #           |-----DL----|             phy_in_DL 4,1
                                        ...
                                        nT = contract(nT, HyAndOnsiteFst,([1,2,4],[0,2,3]))
                                        # Guess now
                                        #           |-----T-----|
                                        #  0 chi---Pt2    |     P1---chi 3
                                        #           |-----DL----|             phy_in_DL 1,4
                            ...
                            if i == args.size and j == args.size and lasttime:
                                ...
                                #                    6
                                if i%2==1:
                                    nT = contract(nT, HyAndOnsiteFst,([2,3,5],[0,2,1]))
                                    tempT = contiguous(permute(nT, (1,6,2,0,3,4,5)))
                                else:
                                    nT = contract(nT, permute(HyAndOnsiteLst, (1,0,3,2)),([2,3],[0,2]))
                                    tempT = contiguous(permute(nT, (1,3,7,8,2,0,4,5,6)))
                                ...
                                if i == 0 and firsttime:
                                    ...
                                    nT = contract(nT, P1,([3,7],[0,1]))
                                    if i%2==1:
                                        nT = contract(nT, HyAndOnsiteFst,([1,2,3],[0,2,1]))
                                        tempT = contiguous(permute(nT, (0,4,1,2,3)))
                                    else:
                                        nT = contract(nT, permute(HyAndOnsiteLst, (1,0,3,2)),([1,2,4],[0,2,3]))
                                        tempT = contiguous(permute(nT, (0,1,4,2,3)))
                    ...
                    for j in range(2*args.size+2):
                        ...
                        if j%2 == 0:
                            if i == args.size and j == args.size and lasttime:
                                ...
                                if i%2==1:
                                    nT = contract(nT, permute(Hx, (1,0,3,2)),([2,3,5],[0,2,1]))
                                ...
                                if i == 0 and firsttime:
                                    ...
                                    if i%2==1:
                                        nT = contract(nT, permute(Hx, (1,0,3,2)),([1,2,3],[0,2,1]))
                                        tempT = contiguous(permute(nT,(0,4,1,2,3)))
                                    else:
                                        nT = contract(nT, Hx,([1,2,4],[0,2,3]))
                                        tempT = contiguous(permute(nT,(0,1,4,2,3)))
                            ...
                            if i == args.size and j == args.size and lasttime:
                                ...
                                if i%2==1:
                                    ...
                                    nT = contract(nT, permute(Hx, (1,0,3,2)),([2,3],[0,2]))
                                    tempT = contiguous(permute(nT, (1,3,7,8,0,2,5,4,6)))
                                ...
                                if i == 0 and firsttime:
                                    ...
                                    if i%2==1:
                                        ...
                                        nT = contract(nT, permute(Hx, (1,0,3,2)),([1,2,4],[0,2,3]))
                                        tempT = contiguous(permute(nT,(0,1,4,2,3)))
