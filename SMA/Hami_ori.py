    ...
    for coord in state.sites.keys():
        ...
        for i in range(args.size):
            if i%2 == 0:
                ...
                temp = contract(FL,T_up[(i)],([0],[0]))
                temp = contract(temp,T_down[(i)],([0,3],[0,3]))
                FL = contract(temp,permute(H, (1,0,3,2)),([0,1,3,4],[0,2,1,3]))
                ...
                temp = contract(FU,T_left[(i)],([0],[0]))
                temp = contract(temp,T_right[(i)],([0,3],[0,3]))
                FU = contract(temp,permute(H, (1,0,3,2)),([0,1,3,4],[0,2,1,3]))
        ...
        for i in range(args.size+1):
            if i%2 == 0:
                ...
                FR = contract(temp,permute(H, (1,0,3,2)),([1,2,4,5],[0,2,1,3]))
                ...
                FD = contract(temp,permute(H, (1,0,3,2)),([1,2,4,5],[0,2,1,3]))
